...
$sql = "update users set geofence_center_lng='$newlnggeo', geofence_center_latit='$newlatitgeo', geofence_radius='$newradiusgeo' where device_id=$device_id and zuster_id=$zuster_id";
if(!$res = mysql_query($sql)) 
{ 
    	trigger_error(mysql_error().'<br />In query: '.$sql); 
...
<html lang="en">
  ...
  <body>
	...
	<ul class="list-group">
       		<a href=#><li class="list-group-item list-group-item-success">Verander Geofence</li></a>
		<a href=#><li class="list-group-item list-group-item-success">Verander nummer</li></a>
		<a href=instellingen?get_device=<?php echo $_GET["get_device"] ?>><li class="list-group-item list-group-item-success">Volg Persoon</li></a>
	</ul>
...
function HomeControl(controlDiv, map) {
  ...
  google.maps.event.addDomListener(controlUI, 'click', function() {
	window.location = "verandergeofence?get_device=<?php echo $device_id ?>&new_geo_latit="+orgCircle.getCenter().lat()+"&new_geo_lng=" 		+orgCircle.getCenter().lng()+"&new_geo_radius="+orgCircle.getRadius();
  });
}
function initialize() {
